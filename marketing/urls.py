...
urlpatterns = [
    path('marketing_courses_category/',views.marketing_courses_category,name='marketing_courses_category'),
    path('marketing_courses_lect/<int:id>/',views.marketing_courses_lect,name='marketing_courses_lect'),
    path('marketing_course_details/<int:id>/',views.marketing_course_details,name='marketing_course_details'),
